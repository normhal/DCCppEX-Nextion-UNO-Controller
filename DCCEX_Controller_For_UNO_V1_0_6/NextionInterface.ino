 ...
 **************************************************************************************************************************
*/
void getNextionText(String unFilteredText)
{
  String receivedText;
  uint8_t i = 0;
  for(i = 0; i < unFilteredText.length(); i++)
  {
    if(unFilteredText[i] != 0x7c)       //remove random mystery character from Nextion data
    {
...
/*    case SSID_NAME:
    ...
    case ACC_CMD_GAP:
      ...
      break;
    case FUNCTION_PULSE_LENGTH:
      writeEEPROMByte(eeFunctionPulse, receivedText.toInt());
      break;
    case PROGRAM_ADDRESS:
      g_programAddress = receivedText.toInt();
      break;
    case CV_NUMBER:
      g_cvNumber = receivedText.toInt();
      break;
    case CV_VALUE:
      g_cvValue = receivedText.toInt();
      break;
    default:
      break;
  }
 ...
 ********************************************************************************************************************
*/
unsigned int getNextionValue(String object)
{
  uint8_t value = 0;
